...
1. truth, truthful, truthfulness -> truth
...
Як бачимо алогоритм для російської мови залишає саме основу слова (та що не змінюється при створені нових форм самого слова). Але слова які хоч і мають той же корень (лес) але не є просто формами основного слова - мають і інший stem.
